...
function update(delta_time) {
	...
	var buf_sp_y = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
	var buf_sp_x = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
	var buf_ac_y = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
	var buf_ac_x = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
	var buf_pos_y = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
	var buf_pos_x = ctx.createBuffer (WebCL.MEM_READ_WRITE, bufSize);
