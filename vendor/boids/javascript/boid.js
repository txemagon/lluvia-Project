...
Boid.prototype.run = function(current_time){
    var that = this
    var near = this.my_world.beings_near(this.zone)
    Mobile.prototype.run.call(this, current_time, near)
    this.interested_in_someone(near)
}

/**
 * @method interested_in_someone
 *
 * Search in the near beings, the boids can be a target.
 *
 * @param {Array}   The near boids in the world.
 *
 */
Boid.prototype.interested_in_someone = function(near){
