 ...
 *
 * The returned {@link Kernel.JSNative.Array} has an extra `input` property, which contains the regexp that generated it as a result. In addition,
 ...
 *
 * @param {RegExp} regexp A {@link Kernel.JSNative.RegExp} object. If a non-RegExp object `obj` is passed, it is
