 ...
 * associative array, use {@link Kernel.JSNative.Object} instead.
 *
 * # Creating an Array
 *
 ...
 * Strings and numbers (not {@link Kernel.JSNative.String} and {@link Kernel.JSNative.Number} objects): `concat` copies the values of
 ...
 * *   For strings and numbers (not {@link Kernel.JSNative.String} and {@link Kernel.JSNative.Number} objects), `slice` copies strings
 ...
 * method.
 *
 * The {@link Kernel.JSNative.Array} object overrides the `toString` method of {@link Kernel.JSNative.Object}. For Array objects, the
