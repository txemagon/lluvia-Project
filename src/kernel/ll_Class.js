        ...
        if (class_method)
          try {
            eval(class_name)[f.name] = ( function(){ 
                                                   ...
                                                   with(this)
                                                   return eval("$$F$$ = function " + f.name + "(" + f.params + "){ " + f.body.replace(/self\./g, class_name + ".").replace(/Self(?!\s*\()/g, "(eval('this'))") + ";}" )} 
                                               )()
          } catch (err) {
          ...
          eval(class_name).prototype[f.name] = ( function(){ 
                                                   ...
                                                   with(this)
                                                   return eval("$$F$$ = function " + f.name + "(" + f.params + "){" + f.body.replace(/self\./g, class_name + ".").replace(/Self(?!\s*\()/g, "(eval('this.constructor'))") + ";}" )} 
                                               )()
       }
     }
  }
